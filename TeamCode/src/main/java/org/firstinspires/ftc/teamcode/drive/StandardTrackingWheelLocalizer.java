...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 312.250; // mm; distance between the left and right wheels
    public static double FORWARD_OFFSET = -112.5; // mm; offset of the lateral wheel
