...
@Autonomous(preselectTeleOp = "Toyota Mark II Simulation", name = "chill red")
public class AutoChillRed extends AutoChill {
    ...
    public TrajectorySequence pathToParking1(){
        return drive.trajectorySequenceBuilder(junctionPose.plus(new Pose2d(100,100,0)))
                .UNSTABLE_addTemporalMarkerOffset(0,()->{
                    riserMotor.setTargetPosition(0);
                    riserMotor.setPower(0.65);
                })
                .lineToConstantHeading(new Vector2d(-300, 900))
                .splineToSplineHeading(new Pose2d(-320,280,pi),3*pi/2.0f)
                .build();
    }
    ...
    public TrajectorySequence pathToParking2(){
        return drive.trajectorySequenceBuilder(junctionPose)
                ...
                .splineToConstantHeading(new Vector2d(-900,290),pi)
                .build();
    }
    ...
    public TrajectorySequence pathToParking3(){
        return drive.trajectorySequenceBuilder(junctionPose)
                ...
                .lineToConstantHeading(new Vector2d(-300, 900))
                .splineToSplineHeading(new Pose2d(-320,380,pi),1.25*pi)
                .splineToConstantHeading(new Vector2d(-1400,420),pi)
                .build();
    }
}
